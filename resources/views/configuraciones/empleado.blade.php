        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    data-id_ciudad_procedencia="{{$row->id_ciudad_procedencia}}"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="antoform2" class="form-horizontal calender" role="form">
                ...
                <div class="form-group col-6">
                        <label id="l-direccion" class="">direccion</label>
                        <div class="">
                    ...
                    <div class="form-group row">
                <div class="form-group col-6">
                        <label id="l-celular" class="">celular</label>
                        <div class="">
                    ...
                    <div class="form-group row">
                        <div class="form-group col-6">
                            <label id="l-id_ciudad_procedencia"  class="">Ciudades</label>
                            <div class="">
                                <select id="id_ciudad_procedencia" name="id_ciudad_procedencia" class="select2_single form-control country" >
                                    <option></option>
                                    @foreach ($tbl_municipios_list as $ciudades)
                                        <option value="{{$ciudades->id}}">{{$ciudades->ciudad_procedencia}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>    
...
var id_cargo=null;
var deleted_at=null;
var id_ciudad_procedencia=null;
...
$("#modal_per_empleado").on("show.bs.modal", function (e) {
    ...
    id_ciudad_procedencia=triggerLink.data("id_ciudad_procedencia");
    ...
    $("#id_ciudad_procedencia").val(id_ciudad_procedencia);
...
$(".modal-footer").on("click", "#btn_guardar_per_empleado", function () {
    ...
    celular=$("#celular").val();
    id_ciudad_procedencia=$("#id_ciudad_procedencia").val();


    var valida = null;
        valida = evaluar( ['identidad' , 'primer_nombre', 'segundo_nombre', 'primer_apellido' , 'direccion', 'celular', 'id_ciudad_procedencia' ] );
...
data: {
 ...
 "celular": celular,
 "correo": correo,
 "id_ciudad_procedencia": id_ciudad_procedencia,
...
var nuevaFilaDT=[
row.id,row.identidad,row.primer_nombre,row.segundo_nombre,row.primer_apellido,row.segundo_apellido,row.direccion,row.celular,row.deleted_at

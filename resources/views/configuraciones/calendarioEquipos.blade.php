                ...
                <table class="jambo_table table table-hover" id="tbl_calendario_partidos" border=1>
                   ...
                   <tbody>
                      ...
                      <tr style="font-size: medium">
                         ...
                         <td scope="row">{{$row->equipo}}</td>
                         <td scope="row">{{$row->equipo_2}}</td>
...
var url_guardar_calendario_partidos= "{{url('/configuracion/calendario/equipos')}}/guardar";
var table=null;
var rowNumber=null;
...
var nuevaFilaDT=[
row.id,row.equipo,row.equipo_2,row.precio,row.fecha_hora_inicio,row.fecha_hora_fin
 ,'<button class="btn btn-primary" data-toggle="modal" data-target="#modal_calendario_partidos"'+ 
 'data-id="'+row.id+'" '+ 
 'data-id_equipo="'+row.id_equipo+'" '+ 
 'data-id_equipo_2="'+row.id_equipo_2+'" '+ 

...
<link rel="stylesheet" href="{{asset('vendors/dist/css/adminlte.min.css')}}">
<!-- pnotify -->
<link href="{{asset('vendors/plugins/pnotify/dist/pnotify.css')}}" media="all" rel="stylesheet" type="text/css" />
<link rel="shortcut icon" type="image/png" href="{{asset('images/logo_enee.jpg')}}">

...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{asset('images/logo_erp.png')}}" alt="AdminLTELogo" height="260" width="260">
  </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              @if (session('ventana_dslams_clientes')=='1')
              <li class="nav-item">
                <a href="{{url('/dslams-clientes')}}" class="nav-link">
                  <i class="far fa-users nav-icon"></i>
                  <p>Dslams Clientes</p>
                </a>
              </li>
              @endif
              @if (session('ventana_dslams')=='1')
              <li class="nav-item">
                <a href="{{url('/dslams')}}" class="nav-link">
                  <i class="far fa-users nav-icon"></i>
                  <p>Dslams</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="">GUAYAPE VISION</a>.</strong>

...
Route::group([
    ...
    Route::group([
      'middleware' => 'auth:api'
        ...
        Route::post('ver_equipos', 'App\Http\Controllers\EquiposController@ver_equipos');
        ...
        Route::get('/streaming/enlaces', 'App\Http\Controllers\PagosController@ver_enlaces_streaming');
    });
});
